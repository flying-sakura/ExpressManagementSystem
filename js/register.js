...
var password;
var check = [false, false, false,false,true, true,false, false,true,true,true];
...
$('.container').find('input').eq(1).change(function() {
    ...
    if ($(this).val().length < 8) {
        ...
        if (atLeastTwo($(this).val()) < 2) {
            fail($(this), 1, '密码中至少包含字母、数字和特殊字符的两种')
        } else {
            success($(this), 1);
        }
    }
...
$('#reset').click(function() {
    ...
    check = [false, false, false,true, true,false, false,true,true,true];
});